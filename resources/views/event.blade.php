      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="mb-5" style="margin: 10px 0px 15px 10px;width: 30%">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>   
                        ...
                        <td>{{$event['end']}}</td>
                        <td>
                                <button type="button" class="btn btn-info edit" data-toggle="modal" data-id="{{$event->id}}" data-target="#modal-update"><i class="fa fa-edit"></i>
                                Update
                                </button>
                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-danger"><i class="fa fa-trash-o"></i>
                            Delete
                        </button>
                      </td>
                    </tr>
